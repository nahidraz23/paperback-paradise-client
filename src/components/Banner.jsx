...
// import MotionBanner from "../assets/motion_banner.svg"
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="flex justify-center lg:justify-start">
                            <Link to={`/listed-books`} class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full lg:border-white shadow-md group">
                                ...
                                <span className="absolute flex items-center justify-center w-full h-full text-purple-600 lg:text-white transition-all duration-300 transform group-hover:translate-x-full ease font-semibold">View The List</span>
